...
export var LZString = {
  ...
  compressToUTF16: function (input: any) {
    if (input == null) return ''
    return (
      LZString._compress(input, 15, function (a: any) {
        return f(a + 32)
      }) + ' '
    )
  },
  ...
  decompressFromUTF16: function (compressed: any) {
    ...
    return LZString._decompress(compressed.length, 16384, function (index: any) {
  ...
  compressToEncodedURIComponent: function (input: any) {
    if (input == null) return ''
    return LZString._compress(input, 6, function (a: any) {
