...
class V7Generator {
  ...
  generate(): UUID {
    ...
    if (typeof value !== 'undefined') {
      ...
      if (typeof valueAfterReset === 'undefined') {
...
const getRandomValues: <T extends Uint8Array | Uint32Array>(buffer: T) => T = (buffer) => {
  // fall back on Math.random() unless the flag is set to true
  // TRICKY: don't use the typeof method === "undefined"here as can't pass the reference
